  ...
  return (
    <div className={`p-6 md:p-12 border-b ${borderClass}`}>
      ...
      <div className="flex gap-4">
        <a href="/devansh_draft_resume.pdf" className={`px-6 py-3 text-sm font-bold uppercase tracking-wider bg-neutral-900 text-white dark:bg-white dark:text-black hover:opacity-90 transition-opacity`}>
          Read Resume
        </a>
        <button 
